    ...
    <div style={{ padding: '28px 32px', display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 1400 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          ...
          <QuickAction icon="🚀" label="Despatch Console"      to="/dispatch/console" colour="#8b5cf6" />
          <QuickAction icon="📝" label="Start Stock Count"     to="/stock-count"      colour="#10b981" />
          <QuickAction icon="📄" label="Create Purchase Order" to="/purchase-orders"  colour="#f59e0b" />
        </div>
      </div>
    </div>
  );
