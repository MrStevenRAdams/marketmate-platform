...
export default function AIGenerateModal({ isOpen, productId, productTitle, channel, credentialId, onClose, onSkip }: Props) {
  ...
  const handleAIGenerate = () => {
    // FIX (Issue 3): URL segment order was inverted.
    // Was:  /marketplace/listings/create/${channel}  ← broken, no such route
    // Now:  /marketplace/${channel}/listings/create  ← matches registered routes
    const basePath = `/marketplace/${channel}/listings/create`;
