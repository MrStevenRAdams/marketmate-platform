    ...
    <div className="ts-page">
      ...
      <div className="ts-header">
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <button className="ts-btn-primary" onClick={() => { setShowInvite(!showInvite); setInviteSuccess(''); setInviteError(''); setLastInviteLink(''); }}>
      ...
      {showInvite && (
        <div className="ts-invite-panel">
          ...
          <form onSubmit={handleInvite} className="ts-invite-form">
            ...
            {inviteSuccess && (
              <div className="ts-msg ts-msg--success" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
      ...
      {/* Members list — always visible, no tabs needed */}
      {loading ? (
              ...
              <div className="ts-member-list">
                {invitations.map(inv => (
                  <div key={inv.token} className="ts-member ts-member--pending">
                    ...
                    <div className="ts-member-actions">
                      <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>Link emailed</span>
