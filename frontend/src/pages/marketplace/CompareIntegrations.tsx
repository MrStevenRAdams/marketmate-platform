              ...
              filtered.map((channel, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: '10px 12px', textAlign: 'center' }}>
                      {isConnected ? (
                        <button onClick={() => navigate('/marketplace/connections')} style={{ padding: '5px 12px', borderRadius: 6, border: '1px solid var(--border)', background: 'var(--surface)', color: 'var(--text)', cursor: 'pointer', fontSize: 12, fontWeight: 500 }}>
                          ⚙️ Manage
                        </button>
                      ) : (
                        <button onClick={() => navigate('/marketplace/connections')} style={{ padding: '5px 12px', borderRadius: 6, border: 'none', background: 'var(--accent, #6366f1)', color: '#fff', cursor: 'pointer', fontSize: 12, fontWeight: 600 }}>
                          + Connect
                        </button>
                      )}
                    </td>
