...
import ShoplineAdapter from './adapters/ShoplineAdapter';
...
export const marketplaceRegistry: MarketplaceAdapter[] = [
  ...
  {
    id: 'shopline-main',
    name: 'Shopline Main Store',
    platform: 'Shopline',
    icon: 'ri-shopping-cart-2-fill',
    color: 'text-teal-500',
    bgColor: 'bg-teal-50',
    isConnected: false,
    FormComponent: ShoplineAdapter,
    syncFromCore: shoplineDataSync,
    validate: validateShoplineData,
  },
  {
    id: 'temu-main',
