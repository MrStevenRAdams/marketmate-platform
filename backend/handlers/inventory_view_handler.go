...
// ============================================================================
// INVENTORY VIEW HANDLER — P0.2
// ============================================================================
// Saved inventory views — per-user column + filter presets.
// Stored in: tenants/{tenant_id}/inventory_views
...
func NewInventoryViewHandler(client *firestore.Client) *InventoryViewHandler {
	return &InventoryViewHandler{client: client}
}
...
func (h *InventoryViewHandler) col(tenantID string) *firestore.CollectionRef {
	return h.client.Collection("tenants").Doc(tenantID).Collection("inventory_views")
}

// ── GET /api/v1/inventory-views ───────────────────────────────────────────────
func (h *InventoryViewHandler) List(c *gin.Context) {
...
// ── POST /api/v1/inventory-views ──────────────────────────────────────────────
func (h *InventoryViewHandler) Create(c *gin.Context) {
	tenantID := tenantIDFromCtx(c)
	userID := c.GetString("user_id")
	ctx := c.Request.Context()
...
// ── PUT /api/v1/inventory-views/:id ───────────────────────────────────────────
func (h *InventoryViewHandler) Update(c *gin.Context) {
	tenantID := tenantIDFromCtx(c)
	viewID := c.Param("id")
	ctx := c.Request.Context()
...
// ── DELETE /api/v1/inventory-views/:id ────────────────────────────────────────
func (h *InventoryViewHandler) Delete(c *gin.Context) {
	tenantID := tenantIDFromCtx(c)
	viewID := c.Param("id")
	ctx := c.Request.Context()
