...
func importTypeFields(importType string) (required []string, optional []string) {
	...
	case "products":
		return []string{"sku", "title"},
			[]string{
				"product_id", "product_type", "parent_sku", "status", "subtitle", "description",
				"brand", "ean", "upc", "asin", "isbn", "mpn", "gtin", "categories", "tags",
				...
				"variant_attr_1_name", "variant_attr_1_value", "variant_attr_2_name", "variant_attr_2_value",
				"variant_attr_3_name", "variant_attr_3_value",
				"image_1", "image_2", "image_3", "image_4", "image_5",
				"bundle_component_skus",
				"attribute_1_name", "attribute_1_value", "attribute_2_name", "attribute_2_value",
				"attribute_3_name", "attribute_3_value", "attribute_4_name", "attribute_4_value",
	...
	templates := map[string]struct {
		...
		"products": {
			...
			headers: []string{
				...
				"quantity", "weight_value", "weight_unit",
				"length", "width", "height", "dimension_unit",
				"variant_attr_1_name", "variant_attr_1_value",
				"variant_attr_2_name", "variant_attr_2_value",
				"variant_attr_3_name", "variant_attr_3_value",
				"image_1", "image_2", "image_3", "image_4", "image_5",
				"bundle_component_skus",
			...
			example: []string{
				"", "simple", "", "MY-SKU-001", "Blue Widget", "", "A high quality widget",
				"AcmeCo", "active", "1234567890123", "", "", "", "", "",
				"Widgets|Blue Widgets", "widget|blue",
